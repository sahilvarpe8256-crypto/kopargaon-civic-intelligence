...
import { updateReportStatus, resetMockData } from '../../services/reportStorage';
...
export default function AdminDashboardPage() {
  ...
  const refreshReports = async (showLoading = true) => {
    ...
    try {
      ...
      const lead = data.leadCluster || (data.reports && data.reports[0]);
      if (lead) setSelectedLeadReport(lead);
