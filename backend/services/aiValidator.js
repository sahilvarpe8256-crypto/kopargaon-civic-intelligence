 ...
 * @param {number} [confidenceThreshold=50] - Threshold below which manual verification is flagged
...
function validateAndNormalizeObservations(rawData, confidenceThreshold = DEFAULT_CONFIDENCE_THRESHOLD) {
  ...
  const threshold = Number(confidenceThreshold) || DEFAULT_CONFIDENCE_THRESHOLD;
